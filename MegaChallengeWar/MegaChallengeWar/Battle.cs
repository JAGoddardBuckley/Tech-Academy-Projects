...
namespace MegaChallengeWar
{
    public class Battle
    {
        ...
        public string PerformBattle(Player player1, Player player2)
        {
            ...
            Evaluate(player1, player2, player1Card, player2Card);
            return _sb.ToString();
        }
        ...
        private void Evaluate(Player player1, Player player2, Card card1, Card card2)
        {
        ...
        private void war(Player player1, Player player2)
        {
            ...
            Evaluate(player1, player2, warCard1, warCard2);
